...
**Version:** 1.3.1 (release-grade Gate A/B/C plus Gate D publishability truth)
**For:** Anyone setting up and running a MYR node

Release authority mapping: npm package version is `1.3.1`; source tag `v1.3.1` is authoritative for finalized release-documentation truth.
